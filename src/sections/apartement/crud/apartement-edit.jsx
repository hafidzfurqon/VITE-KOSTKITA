        ...
        <Card sx={{ mt: 5 }}>
          <Container>
            <Stack spacing={3} sx={{ px: 3, py: 3, mb: 3 }}>
              ...
              />
              <InputLabel htmlFor="harga-per-1-2bulan">Harga Per 1-2 Bulan*</InputLabel>
              <Controller
                name="price_1_2_bulan"
                control={control}
                defaultValue=""
                rules={{ required: 'Harga wajib diisi' }}
                render={({ field, fieldState }) => (
              ...
              />
              <InputLabel htmlFor="harga-per-1-2bulan">
                Harga Coret Per 1-2 Bulan (Optional)
              </InputLabel>
              <Controller
                name="price_coret_1_2_bulan"
                control={control}
                defaultValue=""
                // rules={{ required: 'Harga  wajib diisi' }}
                render={({ field, fieldState }) => (
              ...
              />
              <InputLabel htmlFor="harga-per-3-5bulan">Harga Per 3-5 Bulan*</InputLabel>
              <Controller
                name="price_3_bulan"
                control={control}
                defaultValue=""
              ...
              />
              <InputLabel htmlFor="harga-per-3-5bulan">
                Harga Coret Per 3-5 Bulan (Optional)
              </InputLabel>
              <Controller
                name="price_coret_per_3_bulan"
                control={control}
                defaultValue=""
                // rules={{ required: 'Harga  wajib diisi' }}
                render={({ field, fieldState }) => (
              ...
              />
              <InputLabel htmlFor="price_6_bulan">Harga Per 6-11 Bulan*</InputLabel>
              <Controller
                name="price_6_bulan"
                control={control}
                defaultValue=""
              ...
              />
              <InputLabel htmlFor="price_6_bulan">Harga Coret Per 6-11 Bulan (Optional)</InputLabel>
              <Controller
                name="price_6_bulan"
                control={control}
                defaultValue=""
