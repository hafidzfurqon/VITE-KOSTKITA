  ...
  return (
    <Container>
      ...
      <Box component="form" onSubmit={handleSubmit(Submitted)}>
        ...
        <TextField select {...register('apply_to')} defaultValue="" label="Promo untuk" fullWidth error={!!errors.type} helperText={errors.type?.message}>
        ...
        <FormControlLabel
          ...
          />
             <TextField select {...register('discount_type')} defaultValue="" label="Tipe Promo" fullWidth error={!!errors.type} helperText={errors.type?.message}>
